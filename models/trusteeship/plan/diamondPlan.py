...
@dataclass
class DiamondPlan(DailyTrusteeshipPlan):
    def __init__(self, remaining_days: int = 0, purchase_days: int = 0, notice: bool = False, buy_plan: AutoBuy_Plan = AutoBuy_Plan.NONE):
        name = "diamond"
        description = "鑽石套餐 (自動**購買每日商品** | 自動**抽獎** | 自動**每日簽到**)"
        features = [FeatureType.AUTO_BUY, FeatureType.AUTO_LOTTERY, FeatureType.AUTO_SIGN_IN]
